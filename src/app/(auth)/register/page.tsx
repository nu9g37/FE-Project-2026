  ...
  return (
    <main className="flex justify-center p-5 m-10">
      <div className="m-5 bg-green-900 rounded-lg w-1/3 shadow-2xl shadow-black">
        <div className="bg-green-950 text-center text-2xl font-bold p-5 rounded-t-lg">Create Account</div>
        ...
        <form className="my-10" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center my-10">
            <input type="password" minLength={6} id="password" name="password" placeholder="Password" 
            className="bg-white py-2 px-5 mx-5 rounded-lg 
            w-[70%] placeholder-gray-500 text-black focus:border-2 focus:border-blue-400 focus:outline-none shadow-lg focus:shadow-2xl"/>
          </div>
